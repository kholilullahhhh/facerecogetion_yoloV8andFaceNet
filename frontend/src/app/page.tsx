  ...
  const features = [
    {
      ...
      description:
        "Menggabungkan keandalan YOLOv8 untuk mendeteksi posisi wajah secara presisi dan FaceNet untuk mengekstraksi vektor embedding wajah secara cepat.",
    ...
    <div className="flex min-h-screen flex-col bg-slate-50/50 text-slate-900 selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 relative z-10">
            <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
              ...
              >
                ...
                >
                  Solusi presensi pintar untuk SMP Aisyiyah Paccinongang.
                  Memangkas waktu pencatatan manual, meningkatkan akurasi
                  kehadiran, dan terintegrasi secara real-time.
                </motion.p>
                ...
                >
                  ...
                  >
                    <Link href="/login">
                      <Button
                        size="lg"
                        className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/20 px-7 group relative overflow-hidden"
                      >
                ...
                <motion.div
                  variants={fadeInUp}
                  className="pt-2 flex flex-wrap items-center gap-4 text-xs text-slate-500 font-medium"
                >
                  {[
                    "YOLOv8 Architecture",
                    "FaceNet Embeddings",
            ...
            <AnimatedSection className="mb-12 text-center">
              ...
              >
                ...
                <p className="mt-2 text-slate-600 text-sm sm:text-base max-w-xl mx-auto">
                  Efisiensi pengelolaan data siswa dan kehadiran dalam satu
                  ...
                  >
                    <motion.div
                      className={`relative rounded-xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-sm overflow-hidden ${
                        isHighlight
                          ? "md:col-span-2 bg-gradient-to-br from-white to-slate-50"
                          : ""
                      }`}
                      whileHover={{
                        y: -6,
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <h3
                          className={`text-lg font-bold text-slate-900 ${isHighlight ? "text-xl" : ""}`}
                        >
                          {feature.title}
                        </h3>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-3 relative">
              ...
              {[
                {
                  step: "01",
                  title: "Registrasi Wajah Siswa",
                  desc: "Unggah foto siswa saat pendaftaran awal. Sistem akan membuat enkoding numerik khusus.",
                  icon: Camera,
                },
                {
                  step: "02",
                  title: "Buka Sesi Presensi",
                  desc: "Guru/Administrator mengaktifkan sesi presensi pada kelas dan mata pelajaran yang berlangsung.",
                  icon: Clock,
                },
                {
                  step: "03",
                  title: "Scan & Terdeteksi",
                  desc: "Siswa cukup menghadap ke kamera. Kehadiran akan langsung tercatat di database harian.",
                  icon: Zap,
                },
              ].map((item, index) => (
                <motion.div
          ...
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 relative z-10">
            ...
            >
              ...
              <p className="mx-auto mt-4 max-w-xl text-slate-400 text-sm sm:text-base">
                Akses panel admin dan guru untuk mulai mengelola kehadiran siswa
                SMP Aisyiyah Paccinongang.
              </p>
              <motion.div
                className="mt-8"
              ...
              >
                <Link href="/login">
                  <Button
                    size="lg"
                    className="bg-blue-600 hover:bg-blue-500 text-white font-medium px-8 shadow-lg shadow-blue-600/30 group relative overflow-hidden"
                  >
                    <span className="relative z-10 flex items-center">
                      Masuk ke Dashboard
      ...
      >
        <div className="mx-auto max-w-6xl px-4 text-center text-xs text-slate-500 sm:px-6">
          <p>
            © {new Date().getFullYear()} SMP Aisyiyah Paccinongang. All rights
            reserved.
          </p>
          <motion.p
